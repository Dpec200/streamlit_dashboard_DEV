...
def main():
    ...
    def oferta_snackys():
        ...
        for i ,mes in enumerate(list(grouped['mes'].unique())):
            ...
            ax.text(x=(i*6 + 0.75*width), s='1era', y=-0.20)
            ...
            ax.text(x=(i*6 + 1.5*width), s='2da', y=-0.20)

            ax.text(x=(i*6 + ((4*width)/2)), s=str.capitalize(mes), y=-0.8)
            ...
            ax.text(x=(i*6 + 2.25*width), y=-0.20, s='3era')
            ...
            ax.text(s='4ta', x=(i*6 + 3*width), y=-0.20)
