...
def main():
    ...
    def oferta_snackys():
        ...
        for i ,mes in enumerate(list(grouped['mes'].unique())):
            ...
            ax.bar(i*6 + 2*width + 0.05, grouped3['2'], width=width, label='semana 2', color='#DFE2E5')
            ax.bar(i*6 + 2*width + 0.05, grouped3['1'], bottom=grouped3['2'], width=width, label='semana 2', color='#2D8DEC')
            ax.text(x=(i*6 + 2*width + 0.05), s='2da', y=-1)

            ax.text(x=(i*6 + ((4*width)/2) + 0.05), s=str.capitalize(mes), y=-2)

            ax.bar(i*6 + 3*width + 0.05, grouped5['2'], width=width, label='semana 3', color='#DFE2E5')
            ax.bar(i*6 + 3*width + 0.05, grouped5['1'], bottom=grouped5['2'], width=width, label='semana 3', color='#2D8DEC')
            ax.text(x=(i*6 + 3*width + 0.05), y=-1, s='3era')

            ax.bar(i*6 + 4*width + 0.05, grouped7['2'], width=width, label='semana 4', color='#DFE2E5')
            ax.bar(i*6 + 4*width + 0.05, grouped7['1'], bottom=grouped7['2'], width=width, label='semana 4', color='#2D8DEC')
            ax.text(s='4ta', x=(i*6 + 4*width + 0.05), y=-1)
