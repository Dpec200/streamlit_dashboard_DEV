...
def main():
    ...
    def oferta_snackys():
        ...
        for i ,mes in enumerate(list(grouped['mes'].unique())):
            ...
            ax.text(x=(i*6 + width), s='1era', y=-0.40, ha='left')
            ...
            ax.text(x=(i*6 + 2*width), s='2da', y=-0.40, ha='left')
            ...
            ax.text(x=(i*6 + 3*width), y=-0.40, s='3era', ha='left')
            ...
            ax.text(s='4ta', x=(i*6 + 4*width), y=-0.40, ha='left')
